...
#define BAD_INIT_PARAM		101 // bad initialisation parameter - a parameter provided to an initialisation function is invalid // THIS HAS BEEN USED
#define OUT_OF_MEMORY		102 // memory allocation failure
#define NULL_PARAM			103 // a parameter provided to a function is NULL (where non-NULL is expected) 						// THIS HAS BEEN USED
